      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          <div className="md:col-span-4">
            <h3 className="text-2xl font-bold text-white mb-4">Amvent</h3>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="LinkedIn"
              >
                <svg className="w-4 h-4 text-white/50 group-hover:text-accent transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-2 md:col-start-6">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-white/50 hover:text-white transition-colors duration-300">
                    {l.label}
                  </Link>
                </li>
              ))}
